export const events = [
    ...
    },
    {
        ...
        eventType: "circuit-robotics",
        eventHashtags: ["Electro", "Soccer"],
        eventCoordinators: ["Sougata Maji [ 8944840396 ]", "Reetam Sau [ 7980614075 ]", "Dwip Bramha [ 6289840501 ]"],
        // eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 2,
        maxMembers: 5,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
        eventDescription: ["Are you ready for a spectacle of wondrous magnitude, unlike any other, that will leave your heart racing with excitement? Look no further than the Electrosoccer Smash-up at SRIJAN'23! This adrenaline-pumping game combines the high-energy atmosphere of match day with the thrilling world of robotics.", "Whether you're a tech aficionado or a soccer fanatic, the Electrosoccer Smash-up is an event you won't want to miss. The anticipation and energy in the air are palpable as you prepare to compete in the arena of the warriors. Get ready to showcase your skills as you build your bots, code your moves, and plan your strategy.", "This is not just any game, my friends, it's an unforgettable experience. The thrill of the competition, the excitement of the crowd, and the camaraderie of your fellow competitors will leave you with memories that will last a lifetime.", "So don't wait - get in on the action and experience the excitement of the Electrosoccer Smash-up! Register now and join us for the most electrifying tech sport event of the year!"],
    ...
    },
    {
        ...
        eventCoordinators: ["Soumyadeep Sarkar [ 9330325248 ]", "Neetideepta Banerjee [ 8585816088  ]"],
        // eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 2,
        maxMembers: 5,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
    ...
    },
     {
        ...
        maxMembers: 2,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
        eventDescription: ["Are you an inquisitive person with an inexplicable curiosity for indemnifying knowledge? Or are you exceptionally brilliant? Or are you just another novice with an appetite for daily streaming affairs from different industries? It doesn't quite matter which one you specifically are. Brace yourselves as Srijan 23 welcomes another season of Quiz-o-mania. A series of intriguing and entertaining probes will pave the way for the new champion of knowledge! As Carl Jung said, 'The ability to ask questions is the greatest resource in learning the truth!' "],
    ...
    },
    {
    ...
    },
      {
        ...
        eventCoordinators: ["Vineet Kothari (L) [ 7044155891 ]", "Priyam Raj [ 8540038841 ]", "Chirag Jaiswal [ 9330715519 ]"],
        // eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 3,
        maxMembers: 3,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
    ...
    },
 {
        ...
        eventCoordinators: ["Vineet Kothari (L) [ 7044155891 ]", "Sayak China [ 6289430439 ]", "Mahak Chajjer [ 8777714983 ]","Anishwar Gupta [ 7003228776 ]"],
        // eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 3,
        maxMembers: 3,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
    ...
    {
        eventId: "025",
        eventName: "Hack for Humanity",
        eventDate: {prelims: ["April 14, 2023"], finals: "April 15, 2023"},
        // eventTime: {prelims: ["10:30AM - 4PM"], finals: "2PM - 5PM"},
        eventPoster: "/assets/events/hackhumanity.png" ,
        eventType: "coding",
        eventHashtags: ["Hackathon", "Challenges"],
        eventCoordinators: ["Ayush Addhyan [ 9801254033 ]", "Chirag Jaiswal [ 9330715519 ]","Ishita Mundhra [ 9330818132 ]","Priyam Raj [ 8540038841 ]"],
        // eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 1,
        maxMembers: 3,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
       eventDescription: ["Code, create, conquer Calling all tech enthusiasts! Join us for an electrifying 10-hour hackathon, powered by CodeClub JUSL, where you can make a real impact on society.","  With cash rewards and exciting prizes up for grabs, the competition will be fierce, and the excitement will be contagious. Imagine the thrill of brainstorming ideas, building prototypes, and presenting your projects to a panel of esteemed judges.  Join us at Hack for Humanity - Empowering Communities through Technology and be part of an unforgettable journey of innovation, camaraderie, and the chance to win cash rewards and exciting prizes. Don't miss out on this thrilling hackathon adventure - register now and get ready to code for a cause"],
 ...
 //        eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
    ...
    },
    {
        ...
        eventDate: {prelims: ["April 14, 2023"], finals: "April 16,2023"},
  //      eventTime: {prelims: ["10:30AM - 4PM"], finals: "2PM - 5PM"},
        eventPoster: "/assets/events/treasurehunt.png" ,
        eventType: "misc",
        eventHashtags: ["Adventure", "Fun"],
        eventCoordinators: ["Abhirup Kabiraj [ 9748303778 ]", "Jagannath Singh [ 8967380127 ]","Ishan Mandal [ 8420586827]"],
  //       eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 3,
        maxMembers: 5,
 //        eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
        eventDescription: ["Whether looking for 'The One piece' or 'Bada W ke neeche wala 10 crore'. The thrill of the chase remains ever-present.","Srijan is back. So is the Treasure Hunt, and now it's bigger than ever. So get your teams ready and prepared as we bring to you the most exciting college treasure hunt you've ever witnessed.","Get ready for the unlimited adrenaline rush. So what are you waiting for? Register your team ASAP. Brainstorm solutions, decipher clues, unravel locations and perform tasks as you race against the clock and your fellow competing teams to solve all the clues presented to and reach the final treasure, which we assure you is worth its weight in gold."],
        eventRules: ["Each team must have at least 3 members and no more than 5 members (at least 1 girl and 1 boy) with at least one member being from Jadavpur University.","Teams must stay together during the Treasure Hunt and teamwork is encouraged to solve the clues and retrieve the coins from each location. Team members must have their phones with active internet connection and Whatsapp."," Each team will be given a clue at the beginning of the treasure hunt. It will be up to the teams to decipher the clues and safely acquire the next clue from each of the locations. Each clue once solved will lead you to a location where you would find another clue.","Upon reaching the location, teams may need to perform the assigned task.","Teams will be scored based on completion of the assigned task and the amount of time taken. Once all clues are collected teams must return to the finish in order to be counted as finished.","The first clue will be distributed to team members at the starting point and the teams may start solving the clue to begin their Treasure Hunt.","Based on the number of teams participating, we would be having a preliminary round where we would be selecting the top teams based on certain parameters. ","Just like the character, Dr. Bravestone and his team could have never made it out of the jungle without the help of Prof. Oberon and his incredible map reading skills, similarly you guys need to form teams with high versatility. ","The objective of this prelims is to find out the teams which not only possess the intellect to solve the clues, but also have the athleticism and the spirit required to be able to take up new challenges and perform them spontaneously.","The actual treasure hunt round begins here.Top teams would be competing against the clock and themselves to find out the real treasure."],
