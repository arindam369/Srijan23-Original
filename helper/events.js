export const events = [
    ...
    },
    {
        ...
        eventDate: {prelims: ["April 15,2023"], finals: "Not Decided Yet"},
        // eventTime: {prelims: ["10:30AM - 4PM"], finals: "2PM - 5PM"},
        eventPoster: "/assets/events/BTG.png" ,
        eventType: "misc",
        eventHashtags: ["Data Analysis", "Challenges"],
        eventCoordinators: ["Aritro Roy Mitra  [ 7044634674 ]", "Uttarayan Roy [ 8017047670 ]","Dipta Surjya Neogi [ 9432495908]"],
        // eventVenue: "SMCC - 4th Floor - Lab",
        minMembers: 1,
        maxMembers: 2,
        // eventShortDescription: "Deciphering their way through clues and challenges set in the world of binary, the fastest team to the Treasure wins",
        eventDescription: ["Smart Traffic Forum is a 3hrs. a long event that can have a single participant or a team of a maximum of 2 members would analyze vehicular traffic data in real-time. Finally, the participants need to work on the data to draw summaries, prepare a dashboard, and utilize the engineering mindset to critically comment on the given data set.","For any further queries or clarifications:","Aritro Roy Mitra - +91 70446 34674","Uttarayan Roy - +91 80170 47670"],
        eventRules: ["No. of team members: 01 (min.) to 02 (max.) Students from various educational institutions and departments of any year of study at the Undergraduate level can work together to form a team. ","Introduction: .bold()","The act of gathering and analyzing information about traffic flow, including the movements of vehicles, pedestrians, and cyclists, is known as traffic data analytics. Decisions about urban planning and transportation management can be based on the data's insights regarding traffic patterns, congestion, and potential safety hazards. Traffic data analytics can assist transportation planners and engineers in optimizing traffic flow, reducing congestion, and enhancing safety on roads by utilizing cutting-edge analytical tools and approaches. The purpose of the event is to use the various data analytics tool in our engineering field to leverage our skills from the four years using these tools to draw engineering conclusions.","Task:".bold(),"You are given the real field co-ordinates of vehicles in a mixed traffic condition for a merging section (two separate traffic streams join to form a single one) along with some other details (length and width of each vehicle, vehicle id and class, and the timeframe corresponding to that field co-ordinates). Additionally, the gore coordinates shall also be given.","Problem Statement:".bold(),"The problem statement will be revealed on the day of the event.","Judging Criteria:".bold(),"1.The speed (both average and instantaneous) must be calculated accurately.","2.The scattered plot of trajectory must be done correctly distinguishing between main and ramp road vehicles.","3.The approach and calculation of the lateral destination and merging point of each ramp vehicle, and the upstream/downstream distinction.","4.The various charts/graphs of speeds according to each vehicle class must be accurate.","5.The final dashboard containing all the data inferences must be presented in one or two slides.","6.The engineering inference that is being presented along with any suggestions for improving the traffic flow will be considered.","General Rules:".bold(),"1.The data analysis should be measured with respect to the original dataset and can be done in any software of choice, but must be finally presented in an EXCEL file.","2.The graphs/dashboarding/plots must be clearly distinguishable and aesthetically appealing","3.The approach in calculating the parameters must be logical and if there are any assumptions in doing so, that must be clearly mentioned beforehand","4.The inferences drawn from the data analysis must be thought of in terms of improving the traffic flow parameters.","For any further queries or clarifications:","Aritro Roy Mitra - +91 70446 34674","Uttarayan Roy - +91 80170 47670"],
